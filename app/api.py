...
def create_api(app):
    ...
    api.add_resource(resources.ColonyCalculateResource, '/api/admins/me/colonies/<int:colony_id>/calculate', '/api/admins/me/colonies/<int:colony_id>/calculate/<int:production_target>')
